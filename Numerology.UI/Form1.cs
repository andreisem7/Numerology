...
namespace Numerology.UI
{
    public partial class frmNumerology : Form
    {
        ...
        private void SetDOBValuesToUI()
        {
            ...
            lblLifeWay.Text = numerologyObject.DOBObject.GetLifeWayNumberString;
        ...
        private void SetNameValuesToUI()
        {
            ...
            lblLifeWayNumberValue.Text = AdjustVisibleResult(numerologyObject.NameObject.GetLifeWayNumberString, 1);
            lblSoulNumberValue.Text = AdjustVisibleResult(numerologyObject.NameObject.GetVowelsOfNameAndSurnameString, 1);
            lblPersonalityNumberValue.Text = AdjustVisibleResult(numerologyObject.NameObject.GetConsonantsOfNameAndSurnameString, 1);
            lblDestinyNumberValue.Text = AdjustVisibleResult(numerologyObject.NameObject.GetVowelsAndConsonantsOfNameAndSurnameString, 1);
            lblPowerNumberValue.Text = AdjustVisibleResult(numerologyObject.NameObject.GetVowelsAndConsonantsOfNameAndSurnameAndlifeWayNumberString, 1);
        }
